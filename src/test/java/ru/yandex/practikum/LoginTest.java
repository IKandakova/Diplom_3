...
public class LoginTest {
    ...
    @Step("Check the login using the \"Log in to account\" button on the main page")
    ...
    @Step("Check the login using the \"Personal Account\" button")
    ...
    @Step("Check the login using the link in the registration form")
    ...
    @Step("Check the login using the link in the password recovery form")
