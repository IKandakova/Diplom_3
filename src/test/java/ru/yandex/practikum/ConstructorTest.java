...
public class ConstructorTest {
	...
	@Description("Check the transition to the \"Sauces\" section")
	...
	@Description("Check the transition to the \"Fillings\" section")
	...
	@Description("Check the transition to the \"Bun\" section")
